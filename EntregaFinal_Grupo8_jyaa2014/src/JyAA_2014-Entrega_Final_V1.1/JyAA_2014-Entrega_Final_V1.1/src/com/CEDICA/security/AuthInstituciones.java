...
/**
 * Servlet Filter implementation class AuthAdmin
 */

public class AuthInstituciones implements Filter {

    /**
     * Default constructor. 
     */
    public AuthInstituciones() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(perfil == null || !perfil.equals("instituciones")){
