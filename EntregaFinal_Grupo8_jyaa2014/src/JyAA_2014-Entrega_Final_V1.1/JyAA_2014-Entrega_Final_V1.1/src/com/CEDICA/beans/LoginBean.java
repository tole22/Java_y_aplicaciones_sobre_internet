...
public class LoginBean implements Serializable{
	...
	public void login(ActionEvent event) {		
		...
		if(user==null || !user.getPassword().equals(password)){	
			...
			if(rol.equals("ROLE_ADMIN")){ sesion.setAttribute("perfil", "administrador"); salida = "/views/administrador/"; }
			if(rol.equals("ROLE_VOLUNTARIO")){sesion.setAttribute("perfil", "voluntario"); salida = "/views/voluntario/"; }
			if(rol.equals("ROLE_PROFESIONAL")){sesion.setAttribute("perfil", "profesional"); salida = "/views/profesional/"; }
			System.out.println(sesion.getAttribute("perfil"));
		}				
	...
	public void loginInstitucion(ActionEvent event) {		
		...
		if(institucion==null || !institucion.getPassword().equals(password)){	
			...
			this.loggedIn = true;
			HttpSession sesion = (HttpSession)FacesContext.getCurrentInstance().getExternalContext().getSession(true);
			sesion.setAttribute("institucionLogueada", institucion);
			sesion.setAttribute("perfil", "instituciones");
			message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Iniciando Sesión...", "");	
